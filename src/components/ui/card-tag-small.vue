<template>
  <Tooltip placement="top" :disabled="isPhone" theme="light"  class="wAuto">
    <template #content>
        <p v-html="$t('cardTag.remainingCards', { count: item.allow_create_count>=0?item.allow_create_count:'∞' })"></p>
    </template>
    <div class="card-tag"
    :class="{
      checked: checked,
